...
\item Das Bild zeigt die zeichnerische Lösung. Danach ist:
	\begin{align*}
	F_r=F_Z-F_F=\SI{120}{\kilo\newton}-\SI{47,1}{\kilo\newton}=\Ergebnis{\SI{72,9}{\kilo\newton}}
	\end{align*}\newpage
\item 
	\begin{align*}
	...
	v_t&=\Ergebnis{\SI{82}{\kilo\meter\per\hour}}
	\end{align*}
\end{enumerate}
}
...
Die Geschwindigkeitsänderungen beim Stoß zweier Massen sind entgegengesetzt gerichtet und verhalten sich umgekehrt proportional zu den Massen.
  \end{block}
  Dabei ist die Summe aller auf das Körpersystem wirkenden Kräfte Null, d.h., dass der Impulserhaltungssatz angewendet werden kann. Dies bedeutet:
	  \begin{block}{Impulserhaltungssatz}
...
\item 
	...
	&=\Ergebnis{\SI{4}{\meter\per\second}}
	\end{align*}
\item 
	\begin{align*}
	...
	&=\Ergebnis{-\SI{2}{\meter\per\second}}\\
	...
	&=\Ergebnis{\SI{6}{\meter\per\second}}
	\end{align*}
\end{enumerate}
}
...
{
  \frametitle{Beispielaufgabe Impulsänderung}
  Aus einem Kanonenrohr mit der Länge $\SI{8,3}{\meter}$ fliegt ein Geschoss mit der Masse $m=\SI{42}{\kilogram}$ und der Geschwindigkeit $v=\SI{680}{\meter\per\second}$. Berechnen Sie
\begin{enumerate}
\item Die Geschosslaufzeit bei konstanter Beschleunigung im Rohr, 
\item die wirkende Kraft auf das Geschoss im Rohr.
\end{enumerate}
}
\frame[allowframebreaks]
{
...
\begin{enumerate}
\item
Es wird eine gleichmäßig beschleunigte Bewegung von $v_0=0$ auf $v_t=\SI{680}{\meter\per\second}$ angenommen. Somit:
	\begin{align*}
	s=\dfrac{v_t\cdot t}{2}\rightarrow t&=\dfrac{2\cdot s}{v_t}\\
	&=\dfrac{2\cdot \SI{8,3}{\meter}}{\SI{680}{\meter\per\second}}=\Ergebnis{\SI{0,0244}{\second}}
	\end{align*}
\item 
	\begin{align*}
	&F\cdot t=m\cdot \Delta v \quad\text{Somit: }\\
	&F=\dfrac{m\cdot \Delta v}{t}=\dfrac{\SI{42}{\kilogram}\cdot \SI{680}{\meter\per\second}}{\SI{0,0244}{\second}}\\
	&F=\SI{1170492}{\newton}=\Ergebnis{\SI{1170,5}{\kilo\newton}}
	\end{align*}
\end{enumerate}
}
